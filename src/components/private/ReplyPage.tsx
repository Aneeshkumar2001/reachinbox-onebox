...
function ReplyPage({ threadId, onClose }: any) {
  ...
  return (
    <div className="bg-gray-400/25 fixed top-0 left-0 flex justify-center items-center h-full w-full z-20">
      <div className="bg-[#141517] w-1/2 h-4/5 rounded-lg border border-[#41464B]">
        ...
        <div className="flex text-sm py-2 border-b border-[#41464B] px-4 pr-8 pt-8 h-3/5">
          <textarea
        ...
        <div className="flex space-x-8 items-center h-16 ml-8 mb-3">
          <div
