...
const Replies: React.FC<Props> = ({ selectedThread }) => {
  ...
  return (
    <div className="overflow-y-scroll no-scrollbar  h-full">
      ...
      <div
        className="cursor-pointer flex items-center fixed bottom-0 left-50 mb-10 bg-gradient-to-r from-[#4B63DD] to-[#0524BFFC] rounded-md px-10 py-2"
        onClick={togglePopUp}
      >
  ...
  return (
    <div className="dark:bg-[#141517] bg-white border dark:border-[#343A40] mx-8 rounded-md my-3">
      <div className="p-4 text-left">
        ...
        <div className="py-4 dark:text-[#E1E0E0] text-[#172B4D] w-2/3">
          HI FIRST_NAME,
        </div>
        <div
